<template lang="jade">
	NavigationBarLayer.VisMaVie_navigation_bar_layer(
...
<script>
	...
	export default {
		...
		props: {
			scrollPositionToReachBeforeLightBackground: Number
		}
...
<style lang="stylus">
	.VisMaVie_navigation_bar_layer .NavigationBar.on--light-background,
